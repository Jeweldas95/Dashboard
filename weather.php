           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="clock.php"><i class="fa fa-qrcode fa-3x"></i> Clock</a>
                    </li>
						   <li  >
                        <a class="active-menu"   href="weather.php"><i class="fa fa-bar-chart-o fa-3x"></i> Weather</a>
                    </li>	
                </ul>
